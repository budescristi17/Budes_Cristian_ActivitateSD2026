...
int main() {
	...
	modificaPretDupaId(radacina, 45, 19000);
	modificaSoferDupaId(radacina, 50, "Andrei Pop");

	NodLista* listaPret = NULL;
	copiazaMasiniPestePret(radacina, 16000, &listaPret);
	printf("Lista masini peste pret:\n");
	afisareLista(listaPret);

	NodLista* listaInterval = NULL;
	copiazaMasiniDupaIntervalId(radacina, 35, 80, &listaInterval);
