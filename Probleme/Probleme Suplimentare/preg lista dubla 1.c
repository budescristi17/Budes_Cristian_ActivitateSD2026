...
void afiseazaComenziClientInvers(ListaDubla lista, const char* numeClient) {
...
int main() {
	...
	adaugaComandaInListaDubla(&lista, initializareComanda(3, "12.04.2026", "18.04.2026", "Ion Popescu", 'A'));

	afiseazaComenziClientInvers(lista, "Ion Popescu");
