...
int main() {
	...
	NodLista* listaPret = copiazaMasiniPestePret(heap, 17000);
	printf("Lista peste pret:\n");
	afisareLista(listaPret);

	NodLista* listaSofer = copiazaMasiniDupaSofer(heap, "Ion");
