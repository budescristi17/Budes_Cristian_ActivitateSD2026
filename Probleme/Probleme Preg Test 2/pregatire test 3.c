...
int main() {
	...
	NodLista* lista = NULL;
	copiazaMasiniDupaSerie(radacina, 'B', &lista);
	printf("Lista seria A:\n");
	afisareLista(lista);

	radacina = stergeMasinaDinAVL(radacina, 20);
	radacina = stergeMasinaDinAVL(radacina, 40);
